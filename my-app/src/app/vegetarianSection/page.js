...
export default function SaladSection({ categories }) {
  ...
  const CATEGORY_ID = "691543273de6738098b8aca7";
  ...
  const handleAddDish = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        showNotification("New dish added to Vegetarian!", "black");
      } else {
