...
export default function CakeSection({ categories }) {
  ...
  const CATEGORY_ID = "6916bb238467e6485b805231";
  ...
  const handleAddDish = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        showNotification("New dish added to Cake!", "black");
      } else {
