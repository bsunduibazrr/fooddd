...
export default function MainDishesSection({ categories }) {
  ...
  const CATEGORY_ID = "690ac3f7e762b2dc267f2f4c";
  ...
  const handleAddDish = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        showNotification("New dish added to Main Dishes!", "black");
      } else {
        ...
        <div className="justify-center items-center gap-4 grid grid-cols-4">
          ...
          >
            ...
            <p className="text-[14px] font-medium text-black text-center">
              Add new Dish to <br /> Main Dishes
            </p>
          </div>
