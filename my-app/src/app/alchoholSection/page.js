...
export default function AlchoholSection({ categories }) {
  ...
  const CATEGORY_ID = "6912c5acb31f946c14c98393";
  ...
  const handleAddDish = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        showNotification("New dish added to Alchohol!", "black");
      } else {
