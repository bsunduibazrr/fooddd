...
export default function LunchSection({ categories }) {
  ...
  const CATEGORY_ID = "690ac3ffe762b2dc267f2f4e";
  ...
  const handleAddDish = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        showNotification("New dish added to Lunch Favs!", "black");
      } else {
