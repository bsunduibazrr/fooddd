...
export default function SetSection({ categories }) {
  ...
  const CATEGORY_ID = "6916bf3b8467e6485b8052cd";
  ...
  const handleAddDish = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        showNotification("New dish added to Set Foods!", "black");
      } else {
