...
export default function BeveragesSection({ categories }) {
  ...
  const CATEGORY_ID = "690ac44ee762b2dc267f2f5a";
  ...
  const handleAddDish = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        showNotification("New dish added to Beverages!", "black");
      } else {
