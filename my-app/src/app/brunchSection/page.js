...
export default function BrunchSection({ categories }) {
  ...
  const CATEGORY_ID = "690ac440e762b2dc267f2f58";
  ...
  const handleAddDish = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        showNotification("New dish added to Brunch!", "black");
      } else {
