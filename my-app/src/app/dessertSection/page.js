...
export default function DessertSection({ categories }) {
  ...
  const CATEGORY_ID = "690ac40ee762b2dc267f2f54";
  ...
  const handleAddDish = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        showNotification("New dish added to Desserts!", "black");
      } else {
