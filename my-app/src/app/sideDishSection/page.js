...
export default function SideDishSection({ categories }) {
  ...
  const CATEGORY_ID = "690ac458e762b2dc267f2f5c";
  ...
  const handleAddDish = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        showNotification("New dish added to Side Dishes!", "black");
      } else {
        ...
        <div className="justify-center items-center gap-4 grid grid-cols-4">
          ...
          >
            ...
            <p className="text-[14px] font-medium text-black text-center">
              Add new Dish to <br /> Side Dishes
            </p>
          </div>
