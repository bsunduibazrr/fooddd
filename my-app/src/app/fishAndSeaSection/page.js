...
export default function FishAndSeaSection({ categories }) {
  ...
  const CATEGORY_ID = "690ac435e762b2dc267f2f56";
  ...
  const handleAddDish = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        showNotification("New dish added to Fish And Sea!", "black");
      } else {
        ...
        <div className="justify-center items-center gap-4 grid grid-cols-4">
          ...
          >
            ...
            <p className="text-[14px] font-medium text-black text-center">
              Add new Dish to <br /> Fish And Sea
            </p>
          </div>
